    ...
    <head>
        ...
        <script>
            ...
            function Submit() {
                ...
                var fname = document.form.username.value,
                ...
                if (fname !== '' && femail !== '' && freemail !== '' && fpassword !== '' && fmonth !== '' && fday !== '' && fyear !== '') {
            ...
            <div id="popupContact">
                ...
                <div id="container">
                    <div id="container_body">
                        <div>
                            <img id="close" src="close.png" alt="reg" onclick ="div_hide()">
                        ...
                        <div id="form_name">
                            <div class="firstname">
                                <form name="form" action='signup.jsp'  method='post' onsubmit="return Submit()">

                                    <div id="errorBox"></div>
                                    <input type="text" name="username" value="" placeholder="username"  class="input_name" >
                                    </div>
                                    ...
                                    <div id="password_form">
                                        <input type="password" name="pwd" value=""  placeholder="New Password" class="input_password">
                                    </div>
                                    ...
                                    <br>
                                    <div>
                                        <h3 class="birthday_title">Gender</h3>
                                    </div>
                                    <div id="radio_button">
                                    ...
                                    <div>
                                        <center><input id="sign_user" type="submit" value="Register"></center>
                                    </div>
                                </form>  
                            </div>
                            <!--form ends--> 
